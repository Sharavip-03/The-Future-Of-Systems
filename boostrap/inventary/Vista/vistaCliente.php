    ...
    <div class="container-fluid d-flex">
        <div class="d-flex" id="wrapper">
            ...
            <div id="page-content-wrapper">
                            ...
                            <div class="container mt-5">
                                ...
                                <div class="tablestyle">
                                    ...
                                    <form action="../Controlador/controladorCliente.php" method="post" class="d-inline">
                                        <button class="btn button-value mb-3" type="submit" name="Acciones"
                                            value="Refrescar tabla">Refrescar tabla</button>
                                    </form>
                                    <button class="btn button-value mb-3 ms-2" data-bs-toggle="modal"
                                        data-bs-target="#addClientModal">Agregar nuevo usuario</button>
                ...
                <button class="btn button-value btn-danger" type="submit" name="Acciones" value="Borrar Cliente">Eliminar</button>                                      </td>';
                                                echo "</tr>";
                                                ...
                                                echo '<div class="mb-3">
                                                        ...
                                                        <input class="form-control" name="Nombre" type="text" value="' . $fila['Nombre'] . '">
                                                      </div>';
                                                echo '<div class="mb-3">
                                                        <label class="form-label">Apellidos</label>
                                                        <input class="form-control" name="Apellidos" type="text" value="' . $fila['Apellidos'] . '">
                                                      </div>';
                                                echo '<div class="mb-3">
                                                        <label class="form-label">Teléfono</label>
                                                        <input class="form-control" name="Telefono" type="text" value="' . $fila['Telefono'] . '">
                                                      </div>';
                                                echo '<div class="mb-3">
                                                        <label class="form-label">Correo</label>
                                                        <input class="form-control" name="Correo" type="text" value="' . $fila['Correo'] . '">
                                                      </div>';
                                                echo '<div class="mb-3">
                                                        <label class="form-label">Dirección</label>
                                                        <input class="form-control" name="Direccion" type="text" value="' . $fila['Direccion'] . '">
                                                      </div>';
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="../Controlador/controladorCliente.php" method="post">
                                                ...
                                                <button class="btn btn-primary" type="submit" name="Acciones"
                                                    value="Crear Cliente">Agregar Cliente</button>
                                            </form>
                                        </div>
